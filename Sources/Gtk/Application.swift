...
public class Application {
  ...
  public init(handle: RawHandle) {
    ...
    let type = gtk_application_get_type()
  ...
  let handle = gtk_application_new(applicationId, flags)

  self.init(handle: unsafeBitCast(handle, UnsafeMutablePointer<GtkApplication>.self))
}
